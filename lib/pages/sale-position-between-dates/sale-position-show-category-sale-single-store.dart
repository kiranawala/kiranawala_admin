...
class ShowCategorySalePositionSingleStore extends StatefulWidget {
  @override
  _ShowCategorySalePositionSingleStoreState createState() =>
      _ShowCategorySalePositionSingleStoreState();
}

class _ShowCategorySalePositionSingleStoreState extends State<ShowCategorySalePositionSingleStore> {
  ...
  void initState() {
    ...
    super.initState();
    print('Brand Sale Analysis');
    selectedStore = 'KIRANAWALA_STORE_11';
    storeTerminals = ['POS_2','POS_11'];
    startDate = DateFormat('dd-MM-yyyy').format(DateTime.now());
    startDateAsDateTime = DateTime.now();
    endDate = DateFormat('dd-MM-yyyy').format(DateTime.now());
    endDateAsDateTime = DateTime.now();
  }
