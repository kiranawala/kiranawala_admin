...
import 'package:kiranawala_admin/pages/sale-position-between-dates/sale-position-select-category-no-return.dart';
...
import 'package:kiranawala_admin/pages/sale-position-between-dates/sale-position-select-store-category-no-return.dart';
import 'package:kiranawala_admin/pages/sale-position-between-dates/sale-position-show-brand-sale-results.dart';
import 'package:kiranawala_admin/pages/sale-position-between-dates/sale-position-show-category-sale-results.dart';
...
class ShowCategorySalePosition extends StatefulWidget {
  @override
  _ShowCategorySalePositionState createState() =>
      _ShowCategorySalePositionState();
}

class _ShowCategorySalePositionState extends State<ShowCategorySalePosition> {
                    ...
                    RaisedButton(
                        ...
                        onPressed:(){
                          ...
                          Navigator.of(context).push<dynamic>
                            (MaterialPageRoute<dynamic>(
                            builder: (BuildContext context){
                              return SelectStoreForCategorySalePositionNoReturn();
                            }
                          )
                          );
                        },
...
//                              print(dateAsString_ddMMyyyy);
                              ...
                              print(selectedStore);
                              print(storeIdTerminalMap[selectedStore]);
