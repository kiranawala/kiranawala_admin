...
class ShowCategorySaleResults extends StatefulWidget {
  @override
  _ShowCategorySaleResultsState createState() => _ShowCategorySaleResultsState();
}

List<Widget> saleByProductCodeWidget = [];

class _ShowCategorySaleResultsState extends State<ShowCategorySaleResults> {
