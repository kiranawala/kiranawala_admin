...
import 'package:kiranawala_admin/pages/inventory-manager/inventory-manager-product-update-create-duplicate.dart';
import 'package:kiranawala_admin/pages/inventory-manager/inventory-manager-product-update-overwrite-price.dart';
                ...
                child: RaisedButton(
                  ...
                  onPressed:(){
                    ...
                    Navigator.of(context).push<dynamic>(
                        MaterialPageRoute<dynamic>(
                            builder:(BuildContext context){
                              return ProductUpdateOverwritePrice();
                            }
                        )
                    );
                  },
                ...
                child: RaisedButton(
                  ...
                  onPressed:(){
                    ...
                    Navigator.of(context).push<dynamic>(
                        MaterialPageRoute<dynamic>(
                            builder:(BuildContext context){
                              return ProductUpdateCreateDuplicate();
                            }
                        )
                    );
                  },
