...
class ProductUpdateOverwritePrice extends StatefulWidget {
  @override
  _ProductUpdateOverwritePriceState createState() => _ProductUpdateOverwritePriceState();
}

class _ProductUpdateOverwritePriceState extends State<ProductUpdateOverwritePrice> {
                      ...
                      child: RaisedButton(
                          ...
                          onPressed:() {
                            ...
                            if (inputValue != null &&
                              ...
                              Firestore.instance.collection('stores').document('KIRANAWALA_STORE_11').collection('PRODUCTS').document(skuToUpdate.toString()).updateData(<String,dynamic>{'price':num.parse(inputValue)});
