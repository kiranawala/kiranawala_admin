...
//import 'package:kiranawala_admin/pages/inventory-manager/stock-inward-check-if-admin.dart';
import 'package:kiranawala_admin/pages/inventory-manager/inventory-manager-load-categories.dart';
import 'package:kiranawala_admin/pages/inventory-manager/inventory-manager-product-lookup.dart';
import 'package:kiranawala_admin/pages/inventory-manager/inventory-manager-product-sale-position.dart';
import 'package:kiranawala_admin/pages/inventory-manager/inventory-manager-request-mobile-number.dart';
...
class InventoryManagerHomePage extends StatefulWidget {
  @override
  _InventoryManagerHomePageState createState() => _InventoryManagerHomePageState();
}

class _InventoryManagerHomePageState extends State<InventoryManagerHomePage> {
...
//  void getCategoriesMaster() async{
//    retrievingCategories = true;
//    categorySearchResults = List<Category>();
//    categories = List<Category>();
//    categoryMaster = List<CategoryDetails>();
//
//    FirebaseDatabase
//        .instance
//        .reference()
...
//        .once()
//        .then((categoriesMasterSnapshot) {
//      if (categoriesMasterSnapshot != null &&
//          categoriesMasterSnapshot.value != null) {
////        print('Categories Master Available');
////        print(categoriesMasterSnapshot.value);
//        List<dynamic> categoryList = categoriesMasterSnapshot.value;
//        categoryList.forEach((dynamic category) {
////          print(category['categoryId'].toString());
////          print(category['categoryName'].toString());
////          print(category['displayName'].toString());
////          print(category['displayPosition'].toString());
////          print(category['isActive'].toString());
////          print(category['isParent'].toString());
//
//          categoryMaster.add(
//              CategoryDetails(
...
//                  category['displayPosition'],
//                  category['isActive'].toString(),
//                  category['isParent'].toString()
//              ));
//        });
//      }
//      else {
////        print('Categories Master List Not Available');
//        retrievingCategories = false;
//        if (this.mounted) {
//          setState(() {});
//        }
//      }
//      print(categoryMaster);
//    });
//
//  }
...
////        print('Product Brands Available');
//
//        if(this.mounted)
//        {
//          setState(() {});
...
//                MaterialPageRoute<dynamic>(
//                  builder:(BuildContext context){
//                    return InventoryManagerCheckIfAdmin();
//                  }
//                )
//              );
              return;
