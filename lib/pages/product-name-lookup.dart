...
class ProductNameLookUp extends StatefulWidget {
  @override
  _ProductNameLookUpState createState() => _ProductNameLookUpState();
}

class _ProductNameLookUpState extends State<ProductNameLookUp> {
