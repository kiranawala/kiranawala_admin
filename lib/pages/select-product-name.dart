...
class SelectProductName extends StatefulWidget {
  @override
  _SelectProductNameState createState() => _SelectProductNameState();
}

class _SelectProductNameState extends State<SelectProductName> {
